...
class MarketSnapshot(models.Model):
	...
	gold_price = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	silver_price = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	crude_oil_price = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	bitcoin_price = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	nifty_50_value = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	sensex_value = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	usd_inr_rate = models.DecimalField(max_digits=20, decimal_places=6, null=True, blank=True)
	created_at = models.DateTimeField(auto_now_add=True)
